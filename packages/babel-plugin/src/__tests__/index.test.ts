...
describe('babel plugin', () => {
  ...
  it('should compress class name for styled component', () => {
    ...
    expect(actual).toIncludeMultiple([
      '.a{font-size:12px}',
      'ac(["_4ya3eE_a", __cmplp.className])',
    ]);
  });
  ...
  it('should compress class name for css props', () => {
    ...
    expect(actual).toIncludeMultiple(['.a{font-size:12px}', 'ac(["_4ya3eE_a"])']);
  });
  ...
  it('should compress class name for ClassNames', () => {
    ...
    expect(actual).toIncludeMultiple(['.a{font-size:12px}', 'className={ac(["_4ya3eE_a"])']);
  });
  ...
  it('should compress nested selector', () => {
    ...
    expect(actual).toIncludeMultiple(['.a >div div div:hover{font-size:12px}', 'ac(["_3Fo79f_a"]']);
  });
  ...
  it('should compress class names according to the map', () => {
    ...
    expect(actual).toIncludeMultiple([
      '._313842uFDC{margin-top:10px}',
      '.a{color:red}',
      '._4ya3eErjyG{font-size:12px}',
      'ac(["_4ya3eErjyG _1UtDYz_a _313842uFDC"]',
    ]);
  });
